...
values."
  (setq-default
   ...
   '(
     ...
     terraform
     journal
     ;; display problems with elm autoformatter :(
     ;; crosshairs
     (shell :variables
